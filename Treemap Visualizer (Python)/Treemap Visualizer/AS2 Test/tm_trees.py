...
class TMTree:
    ...
    *methods* for this interface.
    ...
    def update_data_sizes(self) -> int:
        ...
        #
        if len(self._subtrees) == 0 and self._parent_tree is None:
            self.data_size = 0
            return 0
    ...
    def collapse(self) -> None:
        ...
        #
        if self._parent_tree is None or self._parent_tree._expanded is False:
            self._expanded = False
            for subtrees in self._subtrees:
            ...
            for subtrees in parent._subtrees:
                if subtrees._expanded is True:
                    subtrees.collapse()
