  ...
  return (
      ...
      <LayoutWrapper>
        <div className="flex-1 overflow-auto p-10 text-gray-800 w-full max-w-none">
          ...
          <h1 className="text-3xl font-bold mb-4 text-[#253657]">Arithmetic Operations</h1>
          ...
          <p className="max-w-[135ch] leading-relaxed mt-4">
            ...
            <span className="font-semibold text-[#2B5DBF]"> addition</span> and 
            <span className="font-semibold text-[#2B5DBF]"> subtraction</span> are performed — 
            using <span className="font-semibold text-[#2B5DBF]"> carry</span> and 
            <span className="font-semibold text-[#2B5DBF]"> borrow</span> bits, as well as the 
            <span className="font-semibold text-[#2B5DBF]"> two’s complement</span> method.
          </p>

          <hr className="my-8 border-t mt-12 border-dotted border-[#9DAAC0] w-full" />

          <h1 className="text-2xl font-bold mt-12 mb-4 text-[#253657]">Binary Addition</h1>
          ...
          <p className="max-w-[135ch] leading-relaxed mt-4">
            ...
            <span className="font-semibold text-[#2B5DBF]"> carry bit</span>. 
          ...
          <p className="max-w-[135ch] leading-relaxed mt-8">
          ...
          <h1 className="text-2xl font-bold mt-12 mb-4 text-[#253657]">Binary Subtraction</h1>


          <p className="max-w-[135ch] leading-relaxed mt-4">
            Similar to binary addition, binary subtraction follows the same logic as subtraction in the 
            <span className="font-semibold text-[#2B5DBF]"> decimal system</span>, except that it only uses the digits 
            ...
            we need to <span className="font-semibold text-[#2B5DBF]">borrow</span> from the next higher bit, 
          ...
          <p className="max-w-[135ch] leading-relaxed mt-8">
            The same principle applies to <span className="font-semibold text-[#2B5DBF]">binary subtraction</span>.  
          ...
          <p className="max-w-[135ch] leading-relaxed mt-4">
            ...
            the <span className="font-semibold text-[#2B5DBF]">two’s complement</span> method.
          </p>


          <hr className="my-8 border-t mt-12 border-dotted border-[#9DAAC0] w-full" />
          <h2 className="text-lg font-bold mt-12 mb-4 text-[#253657]">Two's Complement Method</h2>

          <p className="max-w-[135ch] leading-relaxed mt-4">
            The <span className="font-semibold text-[#2B5DBF]">two’s complement</span> method is an easier and faster way to perform subtraction in binary.  
         ...
         <h2 className="text-base font-bold mt-8 mb-4 text-[#253657]">Steps to Perform Subtraction Using Two’s Complement</h2>
          ...
          <hr className="my-8 border-t mt-12 border-dotted border-[#9DAAC0] w-full" />
          <h2 className="text-lg font-bold mt-12 mb-4 text-[#253657]">The Addition of Negative Numbers</h2>
