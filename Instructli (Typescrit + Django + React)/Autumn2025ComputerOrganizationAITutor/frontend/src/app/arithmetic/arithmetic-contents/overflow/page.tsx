...
export default function OverflowPage() {
  return (
      ...
      <LayoutWrapper>
        <div className="flex-1 overflow-auto p-10 text-gray-800 w-full max-w-none">
          ...
          <h1 className="text-3xl font-bold mb-4 text-[#253657]">Understanding Overflow</h1>
          ...
          <p className="max-w-[135ch] leading-relaxed mt-4">
            ...
            This condition is known as an  <span className="font-semibold text-[#2B5DBF]"> overflow</span>.
          </p>
          ...
          <h1 className="text-2xl font-bold mt-12 mb-4 text-[#253657]">Unsigned Overflow</h1>

          <p className="max-w-[135ch] leading-relaxed mt-4">
            When performing arithmetic operations on <span className="font-semibold text-[#2B5DBF]">unsigned integers</span>, 
          ...
          <p className="max-w-[135ch] leading-relaxed mt-4">
            ...
            This situation is what we call an <span className="font-semibold text-[#2B5DBF]">overflow</span>.
          </p>


          <hr className="my-8 border-t mt-12 border-dotted border-[#9DAAC0] w-full" />
          <h1 className="text-2xl font-bold mt-12 mb-4 text-[#253657]">Signed Overflow</h1>

          <p className="max-w-[135ch] leading-relaxed mt-4">
            When performing arithmetic operations on <b>signed integers</b> (using 
            <span className="font-semibold text-[#2B5DBF]"> two’s complement</span> representation), 
          ...
          <p className="max-w-[135ch] leading-relaxed mt-4">
            In an 8-bit system that uses <span className="font-semibold text-[#2B5DBF]">two’s complement</span> representation, 
  ...
  <         span className="font-semibold text-[#2B5DBF]"> signed overflow</span>.
          </p>
          

          <hr className="my-8 border-t mt-12 border-dotted border-[#9DAAC0] w-full" />
          <h1 className="text-2xl font-bold mt-12 mb-4 text-[#253657]">Handling Overflow: Saturated vs Unsaturated</h1>
          ...
          <h2 className="text-lg font-bold mt-12 mb-4 text-[#253657]">Unsaturated Arithmetic</h2>

          <p className="max-w-[135ch] leading-relaxed mt-2">
            In <span className="font-semibold text-[#2B5DBF]">unsaturated arithmetic</span>, 
          ...
          <hr className="my-8 border-t mt-12 border-dotted border-[#9DAAC0] w-full" />
          <h2 className="text-lg font-bold mt-12 mb-4 text-[#253657]">Saturated Arithmetic</h2>

          <p className="max-w-[135ch] leading-relaxed mt-2">
            In <span className="font-semibold text-[#2B5DBF]">saturated arithmetic</span>, 
          ...
          <p className="max-w-[135ch] leading-relaxed mt-4">
            ...
            In <span className="font-semibold text-[#2B5DBF]">saturated arithmetic</span>, instead of storing this wrong result, 
          ...
          <p className="max-w-[135ch] leading-relaxed mt-8">
            ...
            In such cases, <span className="font-semibold text-[#2B5DBF]">saturated arithmetic</span> 
