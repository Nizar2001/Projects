...
export default function SignedRepresentationsPage() {
  return (

      <LayoutWrapper>
        <div className="flex-1 overflow-auto p-10 text-gray-800 w-full max-w-none">
          <h1 className="text-3xl font-bold mb-4 text-[#253657]">Number Representation</h1>
          <p className="max-w-[135ch] leading-relaxed">
          ...
          <p className="max-w-[135ch] leading-relaxed mt-4">
            ...
            <span className="font-semibold text-[#2B5DBF]"> integers</span> and 
            <span className="font-semibold text-[#2B5DBF]"> floating-point values</span>. </p>

            <p className="max-w-[135ch] leading-relaxed mt-4">
            In this section, we’ll focus on 
            <span className="font-semibold text-[#2B5DBF]"> integers</span> — 
            ...
            <span className="font-semibold text-[#2B5DBF]"> unsigned </span> 
            can only represent  zero and  positive values, 
            while <span className="font-semibold text-[#2B5DBF]"> signed </span> numbers 
          ...
          <h1 className="text-2xl font-bold mt-12 mb-4 text-[#253657]">Unsigned Representation</h1>


          <p className="max-w-[135ch] leading-relaxed">
            When integers are treated as <span className="font-semibold text-[#2B5DBF]">unsigned</span>, they represent
          ...
          <h3 className="text-lg font-bold mt-8 mb-3 text-[#253657]">Example</h3>
          ...
          <h1 className="text-2xl font-bold mt-12 mb-4 text-[#253657]">Signed Representation</h1>
          ...
          <p className="max-w-[135ch] leading-relaxed mt-4">
            ...
            To make this possible, computers use <span className="font-semibold text-[#2B5DBF]">signed representation</span>, 
          ...
          <p className="max-w-[135ch] leading-relaxed mt-4">
            ...
            <span className="font-semibold text-[#2B5DBF]"> sign-magnitude</span> and 
            <span className="font-semibold text-[#2B5DBF]"> two’s complement</span>. 
            ...
            <span className="font-semibold text-[#2B5DBF]"> sign-magnitude</span> and then moving to
            <span className="font-semibold text-[#2B5DBF]"> two’s complement</span>.
          </p>
          ...
          <h1 className="text-2xl font-bold mt-12 mb-4 text-[#253657]">Sign-Magnitude</h1>




          <p className="max-w-[135ch] leading-relaxed mt-4">
            The <span className="font-semibold text-[#2B5DBF]">sign-magnitude representation</span> 
            is one of the simplest ways to represent signed integers in binary. 
            In this method, the leftmost bit, known as the 
            <span className="font-semibold text-[#2B5DBF]"> most significant bit (MSB)</span>, 
            indicates the sign of the number, while the remaining bits represent its 
            <span className="font-semibold text-[#2B5DBF]"> magnitude</span> or absolute value.
          ...
          <h2 className="text-lg font-bold mt-12 mb-4 text-[#253657]">Limitation: Two Representations of Zero</h2>

          <p className="max-w-[135ch] leading-relaxed mt-2">
            However, the <span className="font-semibold text-[#2B5DBF]">sign-magnitude</span> system has one major problem — 
            it allows for two different representations of zero: one positive and one negative.
          </p>

          <div className="font-mono text-sm leading-relaxed bg-gray-50 p-4 rounded-lg border border-gray-200 mt-2">
            <pre>0 0000000 → +0</pre>
            <pre>1 0000000 → −0</pre>
          </div>
         ...
         <p className="max-w-[135ch] leading-relaxed mt-4">
          ...
          <h1 className="text-2xl font-bold mt-12 mb-4 text-[#253657]">Two's Complement</h1>


          <p className="max-w-[135ch] leading-relaxed mt-4">
            The <span className="font-semibold text-[#2B5DBF]"> two’s complement representation</span> 
        ...
        <h3 className="text-lg font-bold mt-12 mb-3 text-[#253657]">Representing Positive Values</h3>
        ...
        <h3 className="text-lg font-bold mt-12 mb-3 text-[#253657]">Representing Negative Values</h3>


        <p className="max-w-[135ch] leading-relaxed mt-4">
          For negative numbers, the <span className="font-semibold text-[#2B5DBF]">two’s complement</span> system 
          uses a different method compared to <span className="font-semibold text-[#2B5DBF]">sign-magnitude</span>. 
          Instead of keeping a separate sign bit, the entire binary pattern is modified to represent a negative value. 
          This is done in two steps.
        </p>

    
        <p className="max-w-[135ch] leading-relaxed mt-4">To represent a negative number, start from its positive binary representation and follow the two steps below:</p>

        <div className="bg-[#f8fafc] border border-gray-200 rounded-lg p-5 mt-4 mb-2">
          <ol className="list-decimal pl-6 space-y-3 text-[15px] text-gray-800">
            <li>
        ...
        <p className="max-w-[135ch] leading-relaxed mt-4">
          ...
          <span className="font-semibold text-[#2B5DBF]"> two’s complement </span> system is:
        </p>
        ...
        <h2 className="text-lg font-bold mt-12 mb-4 text-[#253657]">Eliminating the Two-Zero Problem</h2>

        <p className="max-w-[135ch] leading-relaxed mt-4">
          One important feature of the 
          <span className="font-semibold text-[#2B5DBF]"> two’s complement </span> system 
          is that it eliminates the issue of having two separate representations of zero, 
          which existed in the <span className="font-semibold text-[#2B5DBF]">sign-magnitude</span> method. 
        </p>
