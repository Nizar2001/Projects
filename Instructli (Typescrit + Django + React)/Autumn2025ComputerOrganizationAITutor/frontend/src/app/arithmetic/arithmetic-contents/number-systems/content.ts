export const numberSystemsContent = `
<div class="flex-1 overflow-auto p-10 text-gray-800 w-full max-w-none">
          <h1 class="text-3xl font-bold mb-4 text-[#253657]">Number Systems</h1>
          <p class="max-w-[125ch] leading-relaxed">
          ...
          <p class="max-w-[125ch] leading-relaxed mt-4">
            ...
            <span class="font-semibold text-[#2B5DBF]"> number systems</span> use different
            sets of symbols and bases to express numbers.
          </p>
          
          <hr class="my-8 border-t mt-12 border-dotted border-[#9DAAC0] w-full" />
 
        <h1 class="text-2xl font-bold mt-12 mb-4 text-[#253657]">What is a Number System?</h1>

          <p class="max-w-[125ch] leading-relaxed mt-4">
              A <span class="font-semibold text-[#2B5DBF]"> number system</span>, as its name suggets, 
              ...
              has two key components: the <span class="font-semibold text-[#2B5DBF]"> base </span> and
               the <span class="font-semibold text-[#2B5DBF]"> symbols </span>.
          </p>

          <p class="max-w-[125ch] leading-relaxed mt-4">
              The <span class="font-semibold text-[#2B5DBF]">base</span> of a number system defines 
              how many unique <span class="font-semibold text-[#2B5DBF]">symbols</span> the system uses 
              ...
              In general, the <span class="font-semibold text-[#2B5DBF]">base</span> of a number system 
          ...
          <p class="max-w-[125ch] leading-relaxed mt-4">
            <span class="font-semibold text-[#2B5DBF]">Symbols</span> of a number system, on the other hand,
            ...
            on its <span class="font-semibold text-[#2B5DBF]">base</span>. For example, a base-2 system like
            <span class="font-semibold text-[#2B5DBF]"> binary</span> uses two symbols, while a
            base-16 system like <span class="font-semibold text-[#2B5DBF]"> hexadecimal</span> uses sixteen
            symbols.
          </p>
          ...
          <h1 class="text-2xl font-bold mt-12 mb-4 text-[#253657]">Common Number Systems</h1>
          <p class="max-w-[125ch] leading-relaxed mt-4">
            Some of the most common examples of these systems are 
            <span class="font-semibold text-[#2B5DBF]"> decimal </span> (base-10), 
            <span class="font-semibold text-[#2B5DBF]"> binary </span> (base-2), 
            <span class="font-semibold text-[#2B5DBF]"> hexadecimal </span> (base-16), 
            and <span class="font-semibold text-[#2B5DBF]"> octal </span> (base-8), which we will discuss in detail.
          </p>

          <h1 class="text-2xl font-bold mt-12 mb-4 text-[#253657]">Decimal System</h1>
                      
            <p class="max-w-[125ch] leading-relaxed mt-4">
              The <span class="font-semibold text-[#2B5DBF]">decimal system</span> is the most widely used number system in everyday life. 
              It is a <span class="font-semibold text-[#2B5DBF]">base-10</span> system, meaning it consists of ten unique symbols: 
            ...
            <p class="max-w-[125ch] leading-relaxed mt-4">
              Because the decimal system is simple and widely understood, we will use it as a
               reference point to explain and understand the 
                ...
                <span class="font-semibold text-[#2B5DBF]"> octal</span>, 
                  and <span class="font-semibold text-[#2B5DBF]"> hexadecimal </span> number systems discussed in the
                   following sections.
            </p>

            <hr class="my-8 border-t mt-12 border-dotted border-[#9DAAC0] w-full" /> 

            <h1 class="text-2xl font-bold mt-12 mb-4 text-[#253657]">Binary System</h1>
              <p class="max-w-[125ch] leading-relaxed mt-4">
                The <span class="font-semibold text-[#2B5DBF]">binary system</span> is the fundamental language of computers. 
              ...
              <p class="max-w-[125ch] leading-relaxed mt-4">
                Binary is a <span class="font-semibold text-[#2B5DBF]">base-2</span> number system that uses only two symbols: 
              ...
              <h2 class="text-lg font-bold mt-12 mb-4 text-[#253657]">Binary to Decimal Conversion</h2>
              ...
              <h2 class="text-lg font-bold mt-12 mb-4 text-[#253657]">Decimal to Binary Conversion</h2>
              ...
              <p class="max-w-[125ch] leading-relaxed mt-4">
                ...
                Each binary digit, known as a <span class="font-semibold text-[#2B5DBF]">bit</span>, 
                corresponds to a power of two, just as digits in the decimal system correspond to powers of ten.
              </p>

            <hr class="my-8 border-t mt-12 border-dotted border-[#9DAAC0] w-full" /> 

            <h1 class="text-2xl font-bold mt-12 mb-4 text-[#253657]">Octal System</h1>

            <p class="max-w-[125ch] leading-relaxed mt-4">
              The <span class="font-semibold text-[#2B5DBF]">octal system</span> is a number system with a 
              <span class="font-semibold text-[#2B5DBF]"> base of 8</span>, which means it uses eight symbols: 
            ...
            <p class="max-w-[125ch] leading-relaxed mt-4">
                The process of converting an <span class="font-semibold text-[#2B5DBF]">octal</span> number to decimal is similar to the one we discussed for binary and decimal conversion. 
            ...
            <p class="max-w-[125ch] leading-relaxed mt-8">
              Similarly, we can convert a <span class="font-semibold text-[#2B5DBF]">decimal</span> number to 
              <span class="font-semibold text-[#2B5DBF]"> octal</span> by repeatedly dividing the decimal number by 8 
            ...
            <h2 class="text-lg font-bold mt-12 mb-4 text-[#253657]">Binary to Octal Conversion</h2>
          

            <p class="max-w-[125ch] leading-relaxed mt-4">
                The process of converting an <span class="font-semibold text-[#2B5DBF]">octal</span> number to 
                <span class="font-semibold text-[#2B5DBF]"> binary</span> is straightforward. 
                Since <b>8 = 2³</b>, each octal digit can be directly replaced by a group of 
                <span class="font-semibold text-[#2B5DBF]"> three binary digits (bits)</span>. 
            ...
            <table class="text-sm border-collapse border border-gray-200 mt-4">
              <thead>
                <tr class="bg-gray-100">
                  <th class="border border-gray-200 px-4 py-2">Octal Digit</th>
                  <th class="border border-gray-200 px-4 py-2">Binary Equivalent</th>
                </tr>
              </thead>
              <tbody>
                <tr><td class="border border-gray-200 px-4 py-1 text-center">0</td><td class="border border-gray-200 px-4 py-1 text-center">000</td></tr>
                <tr><td class="border border-gray-200 px-4 py-1 text-center">1</td><td class="border border-gray-200 px-4 py-1 text-center">001</td></tr>
                <tr><td class="border border-gray-200 px-4 py-1 text-center">2</td><td class="border border-gray-200 px-4 py-1 text-center">010</td></tr>
                <tr><td class="border border-gray-200 px-4 py-1 text-center">3</td><td class="border border-gray-200 px-4 py-1 text-center">011</td></tr>
                <tr><td class="border border-gray-200 px-4 py-1 text-center">4</td><td class="border border-gray-200 px-4 py-1 text-center">100</td></tr>
                <tr><td class="border border-gray-200 px-4 py-1 text-center">5</td><td class="border border-gray-200 px-4 py-1 text-center">101</td></tr>
                <tr><td class="border border-gray-200 px-4 py-1 text-center">6</td><td class="border border-gray-200 px-4 py-1 text-center">110</td></tr>
                <tr><td class="border border-gray-200 px-4 py-1 text-center">7</td><td class="border border-gray-200 px-4 py-1 text-center">111</td></tr>
              </tbody>
            </table>
          ...
          <h2 class="text-lg font-bold mt-12 mb-4 text-[#253657]">Octal to Binary Conversion</h2>
          ...
          <p class="max-w-[125ch] leading-relaxed mt-4">
            ...
            <span class="font-semibold text-[#2B5DBF]"> octal number </span> back into 
            <span class="font-semibold text-[#2B5DBF]"> binary</span>. 
          ...
          <h1 class="text-2xl font-bold mt-12 mb-4 text-[#253657]">Hexadecimal System</h1>

      <p class="max-w-[125ch] leading-relaxed mt-4">
        The <span class="font-semibold text-[#2B5DBF]">hexadecimal system</span> is another commonly used number system, 
        especially in computer science. It has a 
        <span class="font-semibold text-[#2B5DBF]"> base of 16</span>, meaning it uses sixteen unique symbols to represent numbers.
      ...
      <h2 class="text-lg font-bold mt-12 mb-4 text-[#253657]">Binary and Hexadecimal Relationship</h2>
      ...
      <p class="max-w-[125ch] leading-relaxed mt-4">
        ...
        <table class="text-sm border-collapse border border-gray-200 mt-4 w-full max-w-[600px] text-center">
          <thead>
            <tr class="bg-gray-100">
              <th class="border border-gray-200 px-4 py-2">Hex</th>
              <th class="border border-gray-200 px-4 py-2">Binary</th>
              <th class="border border-gray-200 px-4 py-2">Hex</th>
              <th class="border border-gray-200 px-4 py-2">Binary</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td class="border border-gray-200 px-3 py-1">0</td><td class="border border-gray-200 px-3 py-1">0000</td>
              <td class="border border-gray-200 px-3 py-1">8</td><td class="border border-gray-200 px-3 py-1">1000</td>
            </tr>
            <tr>
              <td class="border border-gray-200 px-3 py-1">1</td><td class="border border-gray-200 px-3 py-1">0001</td>
              <td class="border border-gray-200 px-3 py-1">9</td><td class="border border-gray-200 px-3 py-1">1001</td>
            </tr>
            <tr>
              <td class="border border-gray-200 px-3 py-1">2</td><td class="border border-gray-200 px-3 py-1">0010</td>
              <td class="border border-gray-200 px-3 py-1">A</td><td class="border border-gray-200 px-3 py-1">1010</td>
            </tr>
            <tr>
              <td class="border border-gray-200 px-3 py-1">3</td><td class="border border-gray-200 px-3 py-1">0011</td>
              <td class="border border-gray-200 px-3 py-1">B</td><td class="border border-gray-200 px-3 py-1">1011</td>
            </tr>
            <tr>
              <td class="border border-gray-200 px-3 py-1">4</td><td class="border border-gray-200 px-3 py-1">0100</td>
              <td class="border border-gray-200 px-3 py-1">C</td><td class="border border-gray-200 px-3 py-1">1100</td>
            </tr>
            <tr>
              <td class="border border-gray-200 px-3 py-1">5</td><td class="border border-gray-200 px-3 py-1">0101</td>
              <td class="border border-gray-200 px-3 py-1">D</td><td class="border border-gray-200 px-3 py-1">1101</td>
            </tr>
            <tr>
              <td class="border border-gray-200 px-3 py-1">6</td><td class="border border-gray-200 px-3 py-1">0110</td>
              <td class="border border-gray-200 px-3 py-1">E</td><td class="border border-gray-200 px-3 py-1">1110</td>
            </tr>
            <tr>
              <td class="border border-gray-200 px-3 py-1">7</td><td class="border border-gray-200 px-3 py-1">0111</td>
              <td class="border border-gray-200 px-3 py-1">F</td><td class="border border-gray-200 px-3 py-1">1111</td>
            </tr>
          </tbody>
        </table>
      ...
      <p class="font-mono text-sm leading-relaxed bg-gray-50 p-4 rounded-lg border border-gray-200">
        1101&nbsp;&nbsp;1110 → D&nbsp;&nbsp;E → <b>DE₁₆</b>
          ...
          <p class="max-w-[125ch] leading-relaxed mt-4">
            Converting from <span class="font-semibold text-[#2B5DBF]">hexadecimal</span> back to 
            <span class="font-semibold text-[#2B5DBF]"> binary</span> is even easier. 
