...
public class Player implements Serializable {
    ...
    /**
     * A HealthBar displaying the health of the player
     */
    ...
    public boolean takeObject(String object){
        if(this.currentRoom.checkIfObjectInRoom(object)){
            ...
            if (!object1.previously_picked()) {
                if (object1.getHealth_effect() >= 0) {
                    this.health.heal(object1.getHealth_effect());

                } else {
                    this.health.harm(object1.getHealth_effect());
                }
                object1.set_picked();
            }
            return true;
    ...
    /**
     * A getter method for the player's healthBar
     * @return the player's healthBar
     */
    ...
    /**
     * A setter method for the player's name.
     * @param name Set the name of the player to the value of name.
     */
